...
(function(){
  ...
  function ensureCss(){if($('microCompactTableStyle'))return;const s=document.createElement('style');s.id='microCompactTableStyle';s.textContent=`
    ...
    @media(max-width:720px){.mobile-tabs{display:none!important}.micro-compact-bar{flex-wrap:nowrap;overflow-x:auto;overscroll-behavior-x:contain;scrollbar-width:none;padding:4px}.micro-compact-bar::-webkit-scrollbar{display:none}.micro-compact-bar .btn{flex:0 0 auto;padding:6px 8px}.micro-compact-grid{flex:0 0 auto}.micro-compact-grid select{min-width:102px;max-width:122px}.micro-compact-spacer{display:none}.toolbar{margin-bottom:5px;gap:4px}.toolbar .btn{padding:6px 7px}.viewport{height:calc(100vh - 220px);min-height:360px}}
    @media(max-height:650px) and (pointer:coarse){.layout{display:block!important}.left,.right{display:none!important}.mobile-tabs{display:none!important}.left.drawer,.right.drawer{display:block!important;position:fixed;left:6px;right:6px;bottom:6px;z-index:900;max-height:65vh;overflow:auto}.right.drawer{grid-template-columns:1fr!important}.map-shell{border-radius:10px;padding:4px}.head{padding:7px 10px}.head h1{font-size:1.15rem}.head small{display:none}.micro-compact-bar{flex-wrap:nowrap;overflow-x:auto;margin-bottom:4px}.toolbar{margin-bottom:4px}.viewport{height:calc(100vh - 165px)!important;min-height:240px!important}.status{display:none}}
