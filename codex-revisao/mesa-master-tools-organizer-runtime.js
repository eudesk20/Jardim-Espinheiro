...
(async function(){
  ...
  function renderTable(){
    ...
    const card=document.createElement("div");card.dataset.masterV2="1";card.dataset.masterTableCard="1";card.className="micro-tool-card";card.innerHTML=`
    ...
    globalThis.MICROCOSMOS_SCENERY?.mount?.(card);
